...
@Id
@GeneratedValue//(strategy=GenerationType.IDENTITY)//auto is the default generation type or strategy//Generation type is the staregy which the jpa should use or follow
